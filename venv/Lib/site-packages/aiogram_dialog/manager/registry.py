...
# from ..message_manager import SuperMesssageManager
...
class DialogRegistry(DialogRegistryProto):
    def __init__(
            ...
            # super_message_manager: Optional[MessageManagerProtocol] = None,
    ):
        self.dp = dp
        self.dialogs = {
        ...
        # if super_message_manager is None:
        #     super_message_manager = SuperMessageManager()
        # self._super_message_manager = super_message_manager
    ...
    @property
    def super_message_manager(self) -> MessageManagerProtocol:
        return self._super_message_manager
